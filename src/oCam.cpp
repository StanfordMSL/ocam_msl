...
private:
    ...
    int image_width_, image_height_; // added by Eric Cristofalo 2018/11/19
    std::string param_file_; // added by Eric Cristofalo 2018/11/19
    ...
    void device_poll() {
        ...
        std::string camera_param_str = "package://" + param_file_; // Added by Eric Cristofalo 2018/11/19
        info_manager.loadCameraInfo( camera_param_str );
...
public:
    ...
    oCamROS() {
        ...
        image_width_ = 0;
        image_height_ = 0;
        param_file_ = "ocam/param/camera.yaml";
        priv_nh.getParam("image_width", image_width_);
        priv_nh.getParam("image_height", image_height_);
        priv_nh.getParam("param_file", param_file_);
